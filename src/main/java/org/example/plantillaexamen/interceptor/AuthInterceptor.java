package org.example.plantillaexamen.interceptor;
...
//este es el ejemplo de pere para filtrar la redireccion del login si no hay sesion
@WebFilter("/game")
// otro ejemplo de uso seria asi: @WebFilter("/privado/*") y protejeria todo lo que estuviera dentro de privado
